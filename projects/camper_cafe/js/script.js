...
function updateProductsBag(){
    ...
    bag.forEach(item => {
        ...
        divProduc.innerHTML = `
            <div class="bg-prod">
                <img src="/projects/camper_cafe/assets/img-camperCafe/${item.img}">
            ...
            <button class="button-delete" id="button-delete" onclick="removeItem(event)"><img src="/projects/camper_cafe/assets/img-camperCafe/cross.png"></button>`
